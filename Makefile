...
40image-6: 40image.o uarray2.o a2plain.o ppm_RGBfloats.o RGBfloats_CV.o \
	 CV_DCTfloats.o DCTfloats_DCTints.o DCTints_codewords.o bitpack.o \
	 Codewords_File.o compress40.o
	$(CC) $(LDFLAGS) $^ -o $@ $(LDLIBS)
